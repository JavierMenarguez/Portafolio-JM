            ...
            <div className="max-w-7xl mx-auto py-20 grid md:grid-cols-2 gap-2 items-end">
                ...
                <div className="mb-10">
                    ...
                    <div className="flex mt-8 mb-4 gap-4">
                        ...
                        <a href='/SOFTWARE DEVELOPER JM.pdf' download={"CVJavierMenarguez.pdf"} className=" flex bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary transition" onClick={() => {
                            window.umami?.track('Descarga CV');
                        }}>
                            Descargar
                        ...
                        <a href="https://www.linkedin.com/in/javier-men%C3%A1rguez-abell%C3%A1n-706a0925a/" target="_blank" rel="noopener noreferrer" className="flex border border-primary text-primary px-6 py-3 rounded-lg hover:bg-green-100 transition" data-umami-event="Linkedin conectado">
                            Linkedin
                    ...
                    <a href='mailto:javiermenarguez1@gmail.com' className="sm:hidden inline-flex border border-primary text-primary px-6 py-3 rounded-lg hover:bg-green-100 transition">
                        Correo electrónico
